...
由于海外大部分网络并不会对代理进行限制，如果需要的是访问国内网络的代理，可以直接用wireguard，简单快捷。
...
### 国内访问海外
可以在阿里云/腾讯云国际版上面购买其他国家/地区的VPS，听说Oracle有免费的VPS可以用，笔者还没试过。
推荐工具: [3x-ui](https://github.com/MHSanaei/3x-ui)
相对来说需要进行的设置会比wireguard更多，但可以有效绕过GFW。
